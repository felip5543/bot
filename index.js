		...
		try {
			...
			mess = {
      		...
      		mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD PRIVATE BOT*',
					...
					ownerG: '[❗] FP? Este é um recurso especial para o FP❌',
					ownerB: '[❗] FP? Este é um recurso especial para o FP ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de AVALANCHE. Registre-se para fazer amizade com AVALANCHE BOT por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar seunome|17\n\n──「 PRIVATE BOT 」──`,
			...
			const ownerNumber = ["5521981218655@s.whatsapp.net"] // coloque seu numero
			const mod = [ownerNumber,"5521981218655@s.whatsapp.net"]//seu numero
			const adminbotnumber = ["5521981218655@s.whatsapp.net"]//seu numero
			const frendsowner = ["5521981218655@s.whatsapp.net"]//seu numero
			const premium = ["5521981218655@s.whatsapp.net","557186613965@s.whatsapp.net",] 
...
case 'take':
                    ...
                    exifst = getRandom('.webp')
                      googlelink = `https://wa.me/5521981218655?text=${prefix}menu`;
                    applelink = `https://wa.me/5521981218655?text=${prefix}menu`;
